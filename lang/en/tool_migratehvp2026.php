...
$string['filterallcoursevisibility'] = 'All course visibility states';
...
$string['filtercoursevisibility'] = 'Course visibility';
$string['filterperpage'] = 'Per page';
$string['coursevisibility'] = 'Course visibility';
$string['courseshown'] = 'Shown';
$string['coursehidden'] = 'Hidden';
$string['courseshownicon'] = 'Course is shown';
$string['coursehiddenicon'] = 'Course is hidden';
$string['hasmigratedicon'] = 'A migrated H5P activity already exists in this course';
...
$string['linkrewrite_heading'] = 'Rewrite migrated activity links';
$string['linkrewrite_desc'] = 'Find old mod_hvp links in selected text areas and map them to migrated mod_h5pactivity links.';
$string['linkrewrite_mapcounthint'] = 'Available migrated mapping rows';
$string['linkrewrite_coursefilterhint'] = 'Current course filter is active: link rewrite actions only process records in that course.';
$string['linkrewrite_availableaftermigration'] = 'Link replacement tools appear after at least one activity has been migrated (completed mapping row exists).';
$string['linkrewrite_selectscopehint'] = 'Select a category or course filter first. Link replacement tools are available only for a selected scope after migration rows exist.';
$string['linkrewrite_target_pages'] = 'Pages (content)';
$string['linkrewrite_target_labels'] = 'Labels and text areas (label intro)';
$string['linkrewrite_target_sections'] = 'Course section summaries';
$string['linkrewrite_preview'] = 'Preview replacements';
$string['linkrewrite_execute'] = 'Apply replacements';
$string['linkrewrite_exportcsv'] = 'Download mapping CSV';
$string['linkrewrite_preview_result'] = 'Preview: {$a->maps} mapping pairs loaded. {$a->records} records contain {$a->replacements} links to replace.';
$string['linkrewrite_execute_result'] = 'Applied: {$a->maps} mapping pairs loaded. Updated {$a->updated} records with {$a->replacements} link replacements. Refreshed course caches: {$a->courses}.';
